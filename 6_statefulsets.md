...
Instanciez un pod kuard (`kubectl run kuard --image= europe-west1-docker.pkg.dev/k8s-formation/k8s-lab/kuard:blue`), faites un `port-forward` et tentez une résolution DNS de :
